  ...
  switch (mOpCode) {
    ...
    case eSpeculativeLoadScript:
      aExecutor->PreloadScript(
          ...
          mScriptReferrerPolicy, false, mIsAsync, mIsDeferOrError, false,
          mIsLinkPreload);
      break;
    case eSpeculativeLoadScriptFromHead:
      aExecutor->PreloadScript(
          ...
          mTypeOrCharsetSourceOrDocumentModeOrMetaCSPOrSizesOrIntegrity,
          mCrossOrigin, mMedia, mReferrerPolicyOrIntegrity,
          mScriptReferrerPolicy, true, mIsAsync, mIsDeferOrError, false,
          mIsLinkPreload);
      break;
    case eSpeculativeLoadNoModuleScript:
      aExecutor->PreloadScript(
          ...
          mTypeOrCharsetSourceOrDocumentModeOrMetaCSPOrSizesOrIntegrity,
          mCrossOrigin, mMedia, mReferrerPolicyOrIntegrity,
          mScriptReferrerPolicy, false, mIsAsync, mIsDeferOrError, true,
          mIsLinkPreload);
      break;
    case eSpeculativeLoadNoModuleScriptFromHead:
      aExecutor->PreloadScript(
          ...
          mTypeOrCharsetSourceOrDocumentModeOrMetaCSPOrSizesOrIntegrity,
          mCrossOrigin, mMedia, mReferrerPolicyOrIntegrity,
          mScriptReferrerPolicy, true, mIsAsync, mIsDeferOrError, true,
          mIsLinkPreload);
      break;
    ...
    case eSpeculativeLoadMaybeComplainAboutCharset: {
      ...
      aExecutor->MaybeComplainAboutCharset(mMsgId, mIsDeferOrError,
                                           (int32_t)line);
    } break;
    default:
